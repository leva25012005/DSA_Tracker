...
[![LeetCode](<https://img.shields.io/badge/LeetCode-Problem%202239-FFA116?style=for-the-badge&logo=leetcode&logoColor=white>)](https://leetcode.com/problems/find-closest-number-to-zero/)
...
| **Problem Link** | [Open in LeetCode](https://leetcode.com/problems/find-closest-number-to-zero/) |
## ⏰ Progress Tracking
...
|---------|------------|-------------|
| [Find K Closest Elements](https://leetcode.com/problems/find-k-closest-elements/) | 🟡 **Medium** | Similar logic |

## 🏢 Companies Asked (Frequency)

### 🔥 High Frequency (80%+)
- **Tiger Analytics** 🔥 100.0%
