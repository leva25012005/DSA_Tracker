...
[![LeetCode](<https://img.shields.io/badge/LeetCode-Problem%201752-FFA116?style=for-the-badge&logo=leetcode&logoColor=white>)](https://leetcode.com/problems/check-if-array-is-sorted-and-rotated/)
...
| **Problem Link** | [Open in LeetCode](https://leetcode.com/problems/check-if-array-is-sorted-and-rotated/) |
## ⏰ Progress Tracking
...
|---------|------------|-------------|
| [Check if All A's Appears Before All B's](https://leetcode.com/problems/check-if-all-as-appears-before-all-bs/) | 🟢 **Easy** | Similar logic |
