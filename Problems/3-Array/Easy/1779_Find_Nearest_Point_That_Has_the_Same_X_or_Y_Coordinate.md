...
[![LeetCode](<https://img.shields.io/badge/LeetCode-Problem%201779-FFA116?style=for-the-badge&logo=leetcode&logoColor=white>)](https://leetcode.com/problems/find-nearest-point-that-has-the-same-x-or-y-coordinate/)
...
| **Problem Link** | [Open in LeetCode](https://leetcode.com/problems/find-nearest-point-that-has-the-same-x-or-y-coordinate/) |
## ⏰ Progress Tracking
...
|---------|------------|-------------|
| [K Closest Points to Origin](https://leetcode.com/problems/k-closest-points-to-origin/) | 🟡 **Medium** | Similar logic |
